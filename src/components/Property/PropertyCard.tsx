...
const PropertyCard = ({ property }: PropertyProps) => {
    ...
    return (
        <div key={property.id} className="bg-white rounded-lg overflow-hidden shadow border border-gray-200 transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg flex flex-col h-full">
