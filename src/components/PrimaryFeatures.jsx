            ...
            {[
              {
                ...
                value: '60% contado, 40% en cuotas sin interés',
              },
              { label: 'Monto inicial:', value: 'U$S 30.000' },
              { label: 'Saldo restante:', value: '24 cuotas' },
            ].map((field) => (
              <div key={field.label}>
      ...
      >
        <div className="px-4 py-6">
          <div className="space-y-4">
            {[
              { label: 'Número de unidades', value: '4' },
              {
              ...
              { label: 'Precio total', value: '$4.000' },
            ].map((item) => (
              <div
                key={item.label}
      ...
      <div className="mt-6 flex justify-center gap-3">
        {features.map((_, featureIndex) => (
          <button
            ...
            key={featureIndex}
            className={clsx(
              'relative h-0.5 w-4 rounded-full border-0',
              featureIndex === activeIndex ? 'bg-gray-300' : 'bg-gray-500'
            )}
            style={{ borderColor: 'transparent', borderWidth: 0, borderStyle: 'solid' }}
