...
import Properties from './[slug]/components/Properties';
...
//                   view === 'grid' ? 'text-[#FB6107]' : 'text-gray-400'
//                 }`}
//               >
...
//                 className={`p-2 rounded ${
//                   view === 'list' ? 'text-[#FB6107]' : 'text-gray-400'
//                 }`}
//               >
...
//                   sortProperties(prevProperties, e.target.value)
//                 )
//               }}
...
//           {properties
//             .filter((property) =>
//               propertyTypeFilter.includes(property.propertyType)
//             )
//             .map((property) => {
...
//                 <div
//                   key={property.id}
//                   className={`bg-white rounded-lg overflow-hidden shadow border border-gray-200 transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg ${
//                     view === 'list' ? 'flex' : ''
//                   }`}
//                 >
//                   {/* Image Container */}
//                   <div
//                     className={`relative ${
//                       view === 'grid' ? 'h-48 w-full' : 'h-40 w-40'
//                     } overflow-hidden`}
//                   >
//                     <div
...
//                   <div
//                     className={`p-4 ${
//                       view === 'list' ? 'border-l' : 'border-t'
//                     } border-gray-200`}
//                   >
//                     <Link
//                       href={`/customer/properties/${property.slug}`}
