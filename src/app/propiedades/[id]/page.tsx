...
import { Loader2, Bed, Bath, SquareCode, Home, Tag, Calendar, Car, MapPin, DollarSign, Send } from "lucide-react"
      ...
      if (property) {
        ...
        const response = await fetch("/api/inquiries", {
          ...
          body: JSON.stringify({
            ...
            title,
            message,
            offeredPrice: offeredPrice ? Number.parseFloat(offeredPrice) : undefined,
          }),
        })
      ...
      <>
        ...
        <main className="container mx-auto px-4 py-16 min-h-[70vh] flex justify-center items-center">
          <div className="flex flex-col items-center">
            ...
            <span className="text-xl font-medium text-gray-700">Cargando propiedad...</span>
          </div>
        </main>
        <Footer />
      </>
      ...
      <>
        ...
        <main className="container mx-auto px-4 py-16 min-h-[70vh] flex flex-col justify-center items-center">
          <div className="text-center max-w-md">
            <h1 className="text-3xl font-bold mb-4 text-gray-800">Propiedad no encontrada</h1>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            <Badge variant="outline" className="font-medium">
              {listingTypeLabels[property.listingType as keyof typeof listingTypeLabels]}
            </Badge>
            <Badge variant="outline" className="font-medium">
          ...
          <div className="flex items-center text-gray-600 mb-4">
            ...
            <span>
              {property.address[0].streetName}, {property.address[0].city}, {property?.address[0]?.state?.name}
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <TabsContent value="gallery" className="mt-0">
                ...
                <div className="grid grid-cols-4 sm:grid-cols-5 gap-2">
                  {property.images.slice(0, 5).map((image, index) => (
                    <div
                      key={image.id}
                      className={`relative aspect-square rounded-md overflow-hidden cursor-pointer border-2 ${activeImageIndex === index ? "border-primary" : "border-transparent"}`}
                  ...
                  <CardContent className="p-6">
                    <div className="mb-6">
                      ...
                      <div className="space-y-1 text-gray-700">
                        ...
                        <p>
                          {property.address[0].city}, {property?.address[0]?.state?.name}{" "}
          ...
          <div>
            <Card className="sticky top-4">
              <CardContent className="p-6">
                <div className="mb-6">
                  <h2 className="text-xl font-semibold mb-2">¿Interesado en esta propiedad?</h2>
                  ...
                  {session ? (
                    <Dialog open={isOpen} onOpenChange={setIsOpen}>
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        ...
                        <DialogFooter>
                          ...
                          <Button onClick={handleSubmitInquiry} disabled={isSubmitting}>
                            {isSubmitting ? (
                              <>
                    ...
                    <div className="space-y-4">
                      <p className="text-sm text-gray-600">Inicia sesión para consultar sobre esta propiedad</p>
                      <Link href="/login">
                        <Button className="w-full" size="lg">
                          Iniciar sesión
                        </Button>
