...
import { EditCostPopup } from './EditCostPopup';
...
const CostosTable = ({ 
  ...
  const [showEditCostPopup, setShowEditCostPopup] = useState(false);
  const [selectedCost, setSelectedCost] = useState<ProyectCost | null>(null);

  const handleEditClick = (cost: ProyectCost) => {
    setSelectedCost(cost);
    setShowEditCostPopup(true);
  };
  ...
  return (
    <>
      ...
      {/* Modal de edición */}
      {showEditCostPopup && selectedCost && currentProyect && (
        <EditCostPopup
          currentProyect={currentProyect}
          cost={selectedCost}
          setShowEditCostPopup={setShowEditCostPopup}
          rubros={rubros}
