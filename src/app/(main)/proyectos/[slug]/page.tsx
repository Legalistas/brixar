...
export default function ProjectDetail({ params }: { params: { slug: string } }) {
    ...
    const ProjectTypeIcon = project.proyectDetails.type === 'APARTMENT' ? Building2 : Home
        ...
        <div className="container mx-auto px-4 py-8 max-w-[1280px]">
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center text-gray-600 gap-2">
                    ...
                    <p className="text-sm">
                        {mainAddress.streetName}, {mainAddress.city}, {mainAddress.state.name}
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="relative aspect-video rounded-lg overflow-hidden">
                        ...
                        />
                        <div className={`absolute top-4 left-4 px-4 py-2 text-sm font-semibold text-white rounded-lg 
                            ${project.phase === 'CONSTRUCTION' ? 'bg-yellow-500' :
                                project.phase === 'COMPLETED' ? 'bg-green-500' : 'bg-blue-500'}`}>
                            {project.phase}
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm">
                                    {project.proyectDetails.type === 'APARTMENT' ? 'Departamento' : 'Casa'}
                                </span>
                            </div>
                    ...
                    {/* Contact Button */}
                    <button onClick={handleRedirect} className="w-full bg-[#FB6107] hover:bg-[#FB6107]/90 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
